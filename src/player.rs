...
fn setup_player(
    ...
    commands
        .spawn(PbrBundle {
            mesh: meshes.add(Mesh::from(shape::Plane { size: ground_size, subdivisions: 0 })),
...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut App) {
        let _ = app
            ...
            .add_systems(Update,(grab_mouse, detect_ground, player_move, player_look, rotate_with_mouse, grabbing, player_grab.before(grabbing)));
    }
}
